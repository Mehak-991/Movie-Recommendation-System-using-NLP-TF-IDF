...
CineMatch AI is a sleek, AI-powered movie recommendation engine built on Django and advanced machine learning algorithms. By leveraging content-based filtering (TF-IDF & SVD), CineMatch AI analyzes thousands of movies to find the perfect match for your movie nights.

No more endless scrolling. Tell CineMatch AI a movie you love, and it handles the rest.

---

## ✨ What Makes CineMatch AI Special?
...
* **🔌 REST API Ready:** Easily integrate CineMatch AI's logic into other frontends or mobile apps.
...
Get CineMatch AI running on your local machine in minutes using our pre-built demo model!

### 1. Clone & Enter
```bash
git clone https://github.com/Mehak-991/cinematch-ai.git
cd cinematch-ai
```
...
```
Visit `http://127.0.0.1:8000/` in your browser. The app works right out of the box with the included 2,000-movie dataset!

---

## 🧠 Training Your Own Model

Want to scale up? CineMatch AI includes a complete training pipeline.
